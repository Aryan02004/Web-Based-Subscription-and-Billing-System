...
const featureCards = [
  {
    title: "India-first billing for recurring revenue",
    description:
  ...
  {
    title: "RBI-aware recurring flows",
    description:
      "Structure subscriptions around compliant renewal journeys, secure sessions, and predictable payment recovery.",
    icon: ShieldCheck,
...
const benefits = [
  {
    title: "UPI and cards",
    description: "Accept UPI, cards, and recurring payments with a local checkout flow customers recognize.",
    icon: Landmark,
  },
  {
    title: "GST invoicing",
    description: "Generate invoice-ready billing records that fit Indian compliance and finance workflows.",
    icon: ReceiptText,
  },
  {
    title: "Revenue analytics",
    description: "Track MRR, churn, collections, and renewals with a dashboard tuned for Indian growth teams.",
    icon: BarChart3,
  },
];
...
const steps = [
  {
    number: "01",
    title: "Register",
    description: "Create your company account and verify the basic business profile.",
  },
  {
    number: "02",
    title: "Create Org",
    description: "Set up your brand, billing settings, and local payment preferences.",
  },
  {
    number: "03",
    title: "Create Plans",
  ...
  },
  {
    number: "04",
    title: "Share Links",
    description: "Launch hosted checkout links and start collecting revenue across India.",
  },
];

const gateways = ["Razorpay", "Stripe", "PayPal", "Adyen"];
      ...
      <header className="fixed inset-x-0 top-0 z-50 border-b border-slate-200/80 bg-white/80 backdrop-blur-xl">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-base font-extrabold tracking-tight text-cyan-700">Subscriptor</p>
              <p className="text-xs text-slate-500">India-first subscription billing</p>
            </div>
          </div>
      ...
      <main className="pt-16">
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-5">
                <h1 className="max-w-2xl text-4xl font-black tracking-tight text-slate-950 sm:text-5xl lg:text-6xl">
                  Billing for <span className="text-cyan-700">India</span>, built for modern subscription teams
                </h1>
                <p className="max-w-xl text-base leading-8 text-slate-600 sm:text-lg">
                  Run recurring revenue in INR, support UPI and cards, and keep invoices, renewals, and collections under one roof.
                </p>
              </div>

              <div className="flex flex-col gap-4 sm:flex-row">
                <Link className="inline-flex items-center justify-center gap-2 rounded-2xl bg-cyan-700 px-7 py-4 text-sm font-semibold text-white shadow-xl shadow-cyan-700/20 transition hover:-translate-y-0.5 hover:bg-cyan-800" to="/register">
                  Start Free Trial
                  <ArrowRight className="h-4 w-4" />
                </Link>
                <Link className="rounded-2xl border border-slate-200 bg-white px-7 py-4 text-sm font-semibold text-cyan-700 transition hover:border-cyan-200 hover:bg-cyan-50" to="/login">
                  Login to Dashboard
                </Link>
              </div>
            </div>
              ...
              <div className="relative rounded-[2rem] border border-white/60 bg-white/80 p-5 shadow-2xl shadow-slate-300/30 backdrop-blur-xl">
                <div className="rounded-[1.5rem] border border-slate-200 bg-slate-950 p-5 text-white">
                  <div className="mb-6 flex items-center justify-between">
                    <div>
                      <p className="text-xs uppercase tracking-[0.3em] text-cyan-300">India revenue dashboard</p>
                      <h2 className="mt-2 text-2xl font-bold">Monthly recurring revenue</h2>
                    </div>
                    <div className="rounded-2xl bg-white/10 px-4 py-2 text-right">
                      <p className="text-xs text-slate-300">Growth</p>
                      <p className="text-lg font-bold text-emerald-300">+24.8%</p>
                    </div>
                  </div>
                  ...
                  <div className="mt-5 rounded-[1.5rem] bg-gradient-to-br from-cyan-500 to-sky-700 p-5">
                    ...
                    <div className="mt-5 flex items-end justify-between gap-4">
                      <div>
                        <p className="text-xs uppercase tracking-[0.25em] text-cyan-100/80">Subscription</p>
                        <p className="mt-2 text-2xl font-bold">Pro Plan</p>
                        <p className="mt-1 text-cyan-50/90">UPI, cards, and local invoices in one flow.</p>
                      </div>
        ...
        <section className="px-4 py-20 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-7xl">
            <div className="mb-14 text-center">
              <p className="text-sm font-semibold uppercase tracking-[0.3em] text-cyan-700">Made for Indian SaaS</p>
              <h2 className="mt-4 text-3xl font-black tracking-tight text-slate-950 sm:text-4xl">Everything you need to run recurring revenue in India</h2>
              <p className="mx-auto mt-4 max-w-2xl text-base leading-7 text-slate-600">
                Subscriptor removes the technical debt of building your own billing stack so your team can focus on product and growth.
              </p>
            </div>

            <div className="grid gap-6 md:grid-cols-3">
              {featureCards.map(({ title, description, icon: Icon, span, accent, inverse }) => (
                <article
                  key={title}
                  className={`overflow-hidden rounded-[2rem] border border-slate-200 p-8 shadow-sm transition hover:-translate-y-1 hover:shadow-xl ${span ?? ""} ${
                    inverse ? "bg-slate-950 text-white" : `bg-gradient-to-br ${accent} from-white to-white`
                  }`}
                >
                  <div className="flex h-full flex-col justify-between gap-8">
                    <div className="space-y-5">
                      <div className={`flex h-14 w-14 items-center justify-center rounded-2xl ${inverse ? "bg-white/10 text-cyan-300" : "bg-cyan-50 text-cyan-700"}`}>
                        <Icon className="h-6 w-6" />
                      </div>
                      <h3 className="max-w-xl text-2xl font-bold tracking-tight">{title}</h3>
                      <p className={`max-w-xl text-base leading-7 ${inverse ? "text-slate-300" : "text-slate-600"}`}>{description}</p>
                    </div>

                    <div className={`flex items-center justify-between border-t pt-5 ${inverse ? "border-white/10" : "border-slate-200"}`}>
                      <span className={`text-sm font-semibold uppercase tracking-[0.22em] ${inverse ? "text-cyan-300" : "text-cyan-700"}`}>
                        Learn more
                      </span>
                      <ChevronRight className={`h-5 w-5 ${inverse ? "text-cyan-300" : "text-cyan-700"}`} />
                    </div>
                  </div>
                </article>
              ))}
        ...
        <section className="bg-white px-4 py-20 sm:px-6 lg:px-8">
          <div className="mx-auto grid max-w-7xl gap-10 md:grid-cols-3">
            {benefits.map(({ title, description, icon: Icon }) => (
              <article key={title} className="rounded-[2rem] border border-slate-200 bg-slate-50 p-8 text-center shadow-sm">
          ...
          <div className="mx-auto max-w-7xl">
            <div className="mb-12 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
              <div>
                ...
                <h2 className="mt-3 text-3xl font-black tracking-tight text-slate-950">Zero to live in minutes</h2>
                <p className="mt-3 max-w-2xl text-base leading-7 text-slate-600">Four simple steps to launch your Indian billing workflow.</p>
              </div>
        ...
        <section className="px-4 py-20 sm:px-6 lg:px-8">
          <div className="mx-auto grid max-w-7xl gap-16 lg:grid-cols-2">
            <div className="order-2 space-y-8 lg:order-1">
              <div>
                <p className="text-sm font-semibold uppercase tracking-[0.3em] text-cyan-700">Hosted checkout</p>
                <h2 className="mt-3 text-3xl font-black tracking-tight text-slate-950 sm:text-4xl">
                  Conversion-optimized checkout pages
                </h2>
              </div>
              <p className="max-w-xl text-base leading-7 text-slate-600">
                Use pre-built pages that support UPI, cards, and multi-currency billing without building your own checkout from scratch.
              </p>
              ...
              <div className="aspect-[4/3] rounded-[2rem] border border-slate-200 bg-gradient-to-br from-slate-950 via-slate-900 to-cyan-900 p-6 text-white shadow-2xl shadow-slate-300/40">
                ...
                <div className="mt-6 rounded-[1.75rem] bg-white/10 p-6 ring-1 ring-white/10 backdrop-blur-sm">
                  <div className="flex items-center justify-between gap-4">
                    <div>
                      <p className="text-xs uppercase tracking-[0.25em] text-cyan-200/80">Premium plan</p>
                      <h3 className="mt-2 text-2xl font-bold">Rs 4,999 / month</h3>
                    </div>
        ...
        <section className="px-4 py-20 sm:px-6 lg:px-8">
          <div className="mx-auto grid max-w-7xl gap-16 lg:grid-cols-2">
            <div className="space-y-8">
              <div>
                <p className="text-sm font-semibold uppercase tracking-[0.3em] text-cyan-700">Payment gateways</p>
                <h2 className="mt-3 text-3xl font-black tracking-tight text-slate-950 sm:text-4xl">Razorpay and global gateways</h2>
              </div>
              <p className="max-w-xl text-base leading-7 text-slate-600">
                Manage mandates, recurring debits, and partial refunds directly from a dashboard built for Indian billing teams.
              </p>

              <div className="flex flex-wrap gap-3">
                {gateways.map((gateway) => (
                  <span key={gateway} className="rounded-full border border-slate-200 bg-white px-4 py-2 text-sm font-semibold text-slate-700 shadow-sm">
                    {gateway.toUpperCase()}
                  </span>
                ))}
              </div>
              ...
              <div className="aspect-[4/3] rounded-[2rem] border border-slate-200 bg-[radial-gradient(circle_at_top_left,_rgba(34,211,238,0.22),_transparent_32%),radial-gradient(circle_at_bottom_right,_rgba(14,165,233,0.22),_transparent_28%),linear-gradient(135deg,_#ffffff,_#eef6ff)] p-6 shadow-2xl shadow-slate-300/40">
                <div className="grid h-full gap-4 sm:grid-cols-2">
                  <div className="rounded-[1.75rem] border border-cyan-100 bg-white/75 p-5 backdrop-blur-sm">
                    <p className="text-sm font-medium text-slate-500">Gateway health</p>
                    <p className="mt-2 text-3xl font-black text-slate-950">99.98%</p>
                  ...
                  <div className="rounded-[1.75rem] border border-cyan-100 bg-white/75 p-5 backdrop-blur-sm">
                    ...
                    <p className="mt-2 text-3xl font-black text-slate-950">1.2M</p>
                    <div className="mt-6 h-2 rounded-full bg-slate-100">
                  ...
                  <div className="sm:col-span-2 rounded-[1.75rem] border border-cyan-100 bg-slate-950 p-5 text-white shadow-lg">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="text-xs uppercase tracking-[0.25em] text-cyan-300">Live infrastructure</p>
                        <h3 className="mt-2 text-xl font-bold">Settlement stream</h3>
                      </div>
        ...
        <section className="px-4 py-20 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-5xl rounded-[2.5rem] bg-slate-950 px-6 py-14 text-center text-white shadow-2xl shadow-slate-300/30 sm:px-10 sm:py-16">
            <h2 className="text-3xl font-black tracking-tight sm:text-4xl">Ready to automate your revenue?</h2>
            <p className="mx-auto mt-4 max-w-2xl text-base leading-7 text-slate-300">
              Join Indian teams scaling faster with Subscriptor&apos;s automated billing infrastructure.
            </p>
            <div className="mt-8 flex flex-col justify-center gap-4 sm:flex-row">
              <Link className="rounded-2xl bg-cyan-500 px-7 py-4 text-sm font-semibold text-slate-950 transition hover:bg-cyan-400" to="/register">
                Start Free Trial
              </Link>
              <Link className="rounded-2xl border border-white/15 bg-white/5 px-7 py-4 text-sm font-semibold text-white transition hover:bg-white/10" to="/login">
                Talk to Sales
              </Link>
            </div>
          </div>
        ...
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[1.2fr_1fr]">
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <span className="text-lg font-extrabold tracking-tight text-slate-950">Subscriptor</span>
            </div>
            <p className="max-w-sm text-sm leading-7 text-slate-600">
              The reliable backbone for Indian recurring businesses. Built for scale, designed for simplicity.
            </p>
            <p className="text-sm text-slate-500">© 2026 Subscriptor Billing Systems. All rights reserved.</p>
          </div>

          <div className="grid grid-cols-2 gap-8 sm:grid-cols-3">
            {[
              ["Product", ["Features", "Integrations", "Analytics"]],
              ["Resources", ["Help Center", "Contact Sales", "Documentation"]],
              ["Legal", ["Privacy Policy", "Terms of Service"]],
            ].map(([heading, items]) => (
              <div key={heading} className="space-y-4">
                <p className="text-xs font-semibold uppercase tracking-[0.25em] text-slate-500">{heading}</p>
